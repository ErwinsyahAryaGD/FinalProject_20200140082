...
import UAS.C.webserviceuas.exceptions.NonexistentEntityException;
import UAS.C.webserviceuas.exceptions.PreexistingEntityException;
...
public class BiodataJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("UAS.C_webserviceuas_jar_0.0.1-SNAPSHOTPU");

    BiodataJpaController() {
